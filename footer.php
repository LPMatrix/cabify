...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Cabify</h4>
                    <p>Cabify allows the people of the community of get taxis easily, fast and stress free.It is a full package solution to help control crowded park and help get a taxi to your destination at ease </p>
                </div>              
                 ...
                 <div class="col-sm-3">
                    ...
                    <ul class="list-unstyled">        
                        ...
                        <li><a href="tour.php">Travel Packages</a></li>
...
<div class="text-center copyright">Powered by <a href="http://dolphintech.tk">dolphintech.tk</a></div>
